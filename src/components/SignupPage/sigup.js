          ...
          <div className="row">
            ...
            <div className="col-md-5 d-flex justify-content-center align-items-center p-0">
              <form
                ...
                className="sign-in-form col-sm-7 col-md-12 col-lg-10 col-xl-9 d-flex flex-column align-items-center pt-2 p-4"
              >
                ...
                {isAllEmpty ? (
                  <p className="all-error text-center">
                ...
                {isErr ? (
                  <p className="all-error text-center">{errorMsg}</p>
                ) : (
                ...
                <p className="msg text-center mt-2">
