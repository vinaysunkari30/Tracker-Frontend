          ...
          <div className="container-fluid">
            <div className="row">
              <nav className="navbar navbar-expand-md nav d-none d-md-block">
                <div className="container-fluid">
                  <Link to="/" className="navbar-brand nav-link" id="full-name">
                    Task Tracker
                  </Link>
                  <button
                  ...
                  <div
                    className={`collapse navbar-collapse tabs-container ${
                      this.state.isNavOpen ? "show" : ""
                    }`}
                  >
                    <div className="navbar-nav nav-link-container d-flex justify-content-evenly">
                      <button className="link-btn">
                        <Link to="/" className="link m-md-1 m-lg-2">
                          Home
                        </Link>
                      </button>
                      <button className="link-btn">
                        <Link to="/projects" className="link m-md-1 m-lg-2">
                          Projects
                        </Link>
                      </button>
                    </div>
              ...
              <nav className="navbar navbar-expand-lg nav d-md-none">
                <div className="container-fluid div">
                  ...
                  <div
                    className={`collapse navbar-collapse tabs-container p-0 ${
                      this.state.isNavOpen ? "show" : ""
                    }`}
                  >
                    <div className="navbar-nav nav-link-container d-flex justify-content-evenly">
                      <Link to="/" className="link" onClick={this.closeNavbar}>
                        <p>Home</p>
                      </Link>
                      <Link
                        to="/projects"
